...
const Navbar = ({ isColoredBg }) => {
  const activeClassName =
    "text-[#FF3F3A] font-medium relative after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:bg-[#FF3F3A]";
  const inactiveClassName =
    "text-[#1E212C] font-medium hover:text-[#FF3F3A] relative transition-colors duration-300 after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[2px] after:bg-[#FF3F3A] after:transition-all after:duration-300 hover:after:w-full";

  const headerBgClass = isColoredBg
    ? "bg-[#FEDCD2] transition-colors duration-300"
    : "bg-white transition-colors duration-300";

  return (
    <header className={`w-full ${headerBgClass} pt-[20px]`}>
      <nav className="max-w-[1230px] w-full m-auto h-[52px] flex items-center justify-between px-4 relative">
        <div className="flex items-center">
          ...
          <div className="ml-[60px] flex items-center gap-[40px]">
            <NavLink
              to="/"
              className={({ isActive }) =>
