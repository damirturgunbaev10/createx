...
const Footer = () => {
  ...
  const activeClassName =
    "text-[#FF3F3A] text-[14px] font-medium relative w-fit after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:bg-[#FF3F3A]";
  ...
  return (
    <footer className="w-full bg-[#1E212C] h-[398px]">
      <div className="max-w-[1230px] mx-auto mt-[80px] h-[198px] flex items-start justify-between px-4">
        <div className="w-[264px] flex flex-col gap-[16px]">
          <svg
            width="130"
            height="22"
            viewBox="0 0 130 22"
          ...
          <p className="text-[#A4A6B3] text-[13px] leading-[1.6] font-normal">
        ...
        <div className="flex flex-col gap-[12px]">
          <h4 className="text-white text-[13px] font-bold uppercase tracking-[1px]">
            Site Map
          </h4>
          <NavLink
            to="/about"
        ...
        <div className="flex flex-col gap-[12px] w-[216px]">
          <h4 className="text-white text-[13px] font-bold uppercase tracking-[1px]">
          ...
          <form onSubmit={handleEmailSubmit} className="relative">
            <input
              ...
              className="w-full h-[44px] bg-[#2B2E3B] border border-[#3D3F4E] rounded-[4px] pl-[14px] pr-[44px] text-[#A4A6B3] text-[13px] placeholder-[#6B6E82] outline-none transition-all duration-300 focus:border-[#FF3F3A] focus:bg-[#32354A]"
            />
            <button
              type="submit"
              className="absolute right-0 top-0 h-[44px] w-[44px] flex items-center justify-center bg-[#FF3F3A] rounded-r-[4px] transition-all duration-300 hover:bg-[#E03530] cursor-pointer"
            >
              <FiSend size={16} className="text-white" />
            </button>
          </form>

          <p className="text-[#6B6E82] text-[11px] leading-[1.5]">
      ...
      <div className="w-full bg-[#292C37]">
        <div className="max-w-[1230px] mx-auto mt-[60px] h-[58px] flex items-center justify-between px-4 ">
          <p className="text-[#6B6E82] text-[13px] flex items-center gap-[4px]">
            © All rights reserved. Made with{" "}
            <AiFillHeart className="text-[#FF3F3A] mx-[2px]" size={12} /> by
            Createx Studio
          </p>

          <button
            onClick={scrollToTop}
            className="text-[#A4A6B3] text-[13px] font-medium tracking-[1px] uppercase flex items-center gap-[6px] transition-colors duration-300 hover:text-[#FF3F3A] cursor-pointer group"
          >
            Go To Top
            <IoArrowUpOutline
              size={16}
